# Company Name Generator Android SDK
...
```gradle
dependencies {
    implementation 'com.github.apiverve:companynamegenerator-api:1.1.13'
}
```
...
```java
import com.apiverve.companynamegenerator.CompanyNameGeneratorAPIClient;
import com.apiverve.companynamegenerator.APIResponse;
import com.apiverve.companynamegenerator.APIException;

// Initialize the client
CompanyNameGeneratorAPIClient client = new CompanyNameGeneratorAPIClient("YOUR_API_KEY");

try {
    // Prepare query parameters
    Map<String, Object> parameters = new HashMap<>();
    parameters.put("keyword", "systems");
...
For detailed API documentation, visit: [https://docs.apiverve.com/ref/companynamegenerator](https://docs.apiverve.com/ref/companynamegenerator)
...
- **Documentation:** [https://docs.apiverve.com/ref/companynamegenerator](https://docs.apiverve.com/ref/companynamegenerator)
- **Issues:** [GitHub Issues](https://github.com/apiverve/companynamegenerator-api/issues)
