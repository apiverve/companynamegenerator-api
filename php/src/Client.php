...
namespace APIVerve\Companynamegenerator;
...
/**
 * Client for the Company Name Generator API
 *
 * @example Basic usage
 * ```php
 ...
 * ```
 *
 * @see https://apiverve.com/marketplace/companynamegenerator?utm_source=php&utm_medium=readme
 */
class Client
{
    private const BASE_URL = 'https://api.apiverve.com/v1/companynamegenerator';
    ...
    {
        if ($this->debug) {
            echo "[APIVerve\CompanynamegeneratorClient] {$message}\n";
        }
    }
}
