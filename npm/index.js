...
class companynamegeneratorWrapper {

    constructor(options) {
        if (!options || typeof options !== 'object') {
            throw new Error('Options object must be provided. See documentation: https://docs.apiverve.com/ref/companynamegenerator');
        }
        ...
        this.validationRules = {"keyword":{"type":"string","required":true},"count":{"type":"integer","required":false,"min":1,"max":10,"default":5}};
    }
    ...
    validateParams(query) {
        ...
        if (errors.length > 0) {
            throw new Error(`Validation failed: ${errors.join(' ')} See documentation: https://docs.apiverve.com/ref/companynamegenerator`);
        }
    }
...
module.exports = companynamegeneratorWrapper;
