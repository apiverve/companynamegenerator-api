...
{
    class CompanyNameGeneratorExample
    {
        private static readonly string API_KEY = Environment.GetEnvironmentVariable("APIVERVE_API_KEY") ?? "YOUR_API_KEY_HERE";
        private static readonly string API_URL = "https://api.apiverve.com/v1/companynamegenerator";

        /// <summary>
        /// Make a GET request to the Company Name Generator API
        /// </summary>
        static async Task<JsonDocument> CallCompanyNameGeneratorAPI()
        {
            try
            {
                ...
                // Query parameters
                var queryParams &#x3D; new Dictionary&lt;string, string&gt; { [&quot;keyword&quot;] &#x3D; &quot;systems&quot;, [&quot;count&quot;] &#x3D; 5 };
        ...
        {
            Console.WriteLine("📤 Calling Company Name Generator API...\n");

            var result = await CallCompanyNameGeneratorAPI();
