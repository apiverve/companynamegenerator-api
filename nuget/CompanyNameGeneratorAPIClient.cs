...
namespace APIVerve.API.CompanyNameGenerator
{
    ...
    /// <summary>
    /// Client for the CompanyNameGenerator API
    /// </summary>
...
#endif
    {
        ...
        {
            { "keyword", new ValidationRule { Type = "string", Required = true } },
        ...
        private void ValidateParams(CompanyNameGeneratorQueryOptions options)
        {
